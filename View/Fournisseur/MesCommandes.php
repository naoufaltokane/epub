...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid text-center">
        ...
        <table class="table table-bordered table-dark text-center">
          <thead class="text-center">
            <tr>
                ...
                <td scope="col"><h4><b>Nom et prénom du client</b></h4></td>
                <td scope="col"><h4><b>Adresse émail du client</b></h4></td>
                <td scope="col"><h4><b>Téléphone du client</b></h4></td>
              ...
              <tr>
                ...
                <td class="col-sm-2">
                  <?php 
                    ...
                    $nom = $client->getM_nom();
                    $prenom = $client->getM_prenom();
                    echo $nom." ".$prenom;
                  ?>
                </td>
                <td class="col-sm-2">
                  <?php 
                    $email=$client->getM_email();
                    echo $email; 
                  ?>
                </td>
                <td class="col-sm-1">
                  <?php 
                    $tel=$client->getM_telephone();
                    echo $tel; 
                  ?>
                </td>
                ...
                ?>
                  <td class="col-sm-3">
                    <div class="btn-group" role="group" aria-label="Basic example">
                      <input type="submit" name="Traiter" value="Traiter" class="btn btn-success">
                      <input type="submit" name="Encours" value="En cours" class="btn btn-info">
     ...
     <center>
    <button type="button" onclick="location.href='MesProduits.php';" class="btn btn-success btn-lg">Mes Produits</button>
