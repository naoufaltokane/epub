     ...
     <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          ...
          <div class="col-md-3">
            <div id="sidebar" class="well sidebar-nav">
              ...
              <ul class="nav nav-pills nav-stacked">
                <li>
                  <button type="button" onclick="location.href='MesProduits.php';" class="btn btn-success col-lg-12">
                    <i class="glyphicon glyphicon-eye-open text-center"></i>
                  </button>
                </li>
              </ul>
            </div>
          ...
          <div class="col-md-3">
            <div id="sidebar" class="well sidebar-nav">
              ...
              <ul class="nav nav-pills nav-stacked">
                <li>
                  <button type="button" onclick="location.href='AjouterProduit.php';" class="btn btn-success col-lg-12">
                    <i class="glyphicon glyphicon-plus text-center"></i>
                  </button>
                </li>
              </ul>
